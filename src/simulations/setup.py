...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'target_to_fuse_simulator = simulations.system_integration.target_to_fuse_simulator:main',
            'object_simulator = simulations.system_integration.simulate_objects:main',
            'calibration_logger = simulations.logging_tools.calibration_logger:main',
            'calculate_parameters = simulations.logging_tools.calculate_parameters:main',
            'test_system_logger = simulations.logging_tools.test_system_logger:main',
