...
def generate_launch_description():
    ...
    detection_logger = TimerAction(period=5.0, actions=[detection_logger_node])

    scripted_driver = TimerAction(period=5.0, actions=[scripted_driver_node])
