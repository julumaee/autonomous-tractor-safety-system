...
class TestSafetyMonitorParameters(unittest.TestCase):
    ...
    def test_parameter_update(self):
        ...
        self.assertEqual(
            self.safety_monitor.detection_active_reset_time,
            6.0,
            msg="detection_active_reset_time parameter did not update correctly",
        )
        self.assertEqual(
            self.safety_monitor.vehicle_stopped_reset_time,
            6.0,
